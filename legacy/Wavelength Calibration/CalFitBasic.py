...
Dumbed down version from full CalFit routine.  Only uses first peak location and other empirically established relationships
to guess some linear dispersion parameters without fitting.

Created by Seth Meeker on 2011-10-05.
...
if __name__ == '__main__':
    ...
    #pp = PdfPages('./223423/cal_223423_basic.pdf')
    #matplotlib.rcParams['font.size']=6
    
    # Load up configuration file
    configfile = './calibration.cfg'
    
    outfile = "./045533/CalFitOut_all_basic.txt"
    pfile = "./045533/FitParams_all_basic.txt"
    #outfile = "./223423/junk_basic.txt"
    #pfile = "./223423/junk_params_basic.txt"
    ...
    for pixel in pixlist:
        ...
        #block of code for plotting gaussian fit to first peak
        '''
        fig2 = plt.figure(2)
        ax2=fig2.add_subplot(111)
        ax2.plot(gx,gy)
        ...
        #giant block of code that does main fitting of data.  Commenting out to just plot fit with initial guesses
        '''
        #ax.plot(fitx,fity)
        #plt.show()
        ...
        print "Second fit p= ",
        print p2
        '''### End of fitting block that has been commented out to try a basic guess ###
        
        #put in original fit parameter guesses as final fit parameters and see how the fits look
        p2 = [B1height,B1peak,B1sig,mguess,bguess,1.1,0.80,IRheight] 
        ...
        fp.write("%9s \t %1d \t %6f \t %6f \t %6f \t %6f \t %6f \t %6f \t %6f \t %6f\n" %(pn,flag,p2[0],p2[1],p2[2],p2[3],p2[4],p2[5],p2[6],p2[7]))
