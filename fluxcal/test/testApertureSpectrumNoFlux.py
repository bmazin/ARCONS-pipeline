...
def main():
    ...
    medianObsSpectrum, wvlBinEdges = obs.getApertureSpectrum(pixelCol=ypix,pixelRow=xpix,radius1=apertureRadius, radius2 = apertureRadius*2.0,weighted=True, fluxWeighted=False, lowCut=3000, highCut=7000)
    ...
    plotFileName = "%s_NoFlux%s.pdf"%(objectName,filenum)
    ...
    txtFileName = "%s_NoFlux%s.txt"%(objectName,filenum)
