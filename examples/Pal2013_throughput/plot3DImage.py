...
rawfile = '/home/srmeeker/ARCONS-pipeline/examples/Pal2013_throughput/121634/hz21_raw_0.npz'
...
fitfile = '/home/srmeeker/ARCONS-pipeline/examples/Pal2013_throughput/121634/hz21_fit_0.npz'
...
for n in range(np.shape(raw)[0]):
    ...
    #raw[n][raw[n]>maximum]=0 #kill pixels that are clearly hot with counts above some maximum
    ax.plot_wireframe(xs,ys,raw[n], rstride=1,cstride=1,color='red')

    #ax.plot_surface(xs,ys,fit[n],rstride=5, cstride=5, color='black',alpha=0.1)
    #raw[n][raw[n]>maximum]=0 #kill pixels that are clearly hot with counts above some maximum
    #ax.plot_wireframe(xs,ys,raw[n], rstride=5,cstride=5,color='red')
