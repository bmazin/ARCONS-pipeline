...
# December 10
# Sequence during 2nd day on object. Moved to confirm position in 082422 between 90 and 105s.'080916' looks great 3030
...
#calTimestamps = ['20121211-074031', '20121211-074031', '20121211-133056', '20121212-133821']
calTimestamps = ['20121211-074031']
seqs = [seq2]
...
#            hotPixMask = hotPixelsOld.findHotPixels(image=frame,firstSec=sec,intTime=integrationTime,weighted=True, display=True)['badflag']
            ...
            hotPixMask = hotPixels.checkInterval(fwhm=3.0, boxSize=5, nSigma=3.0, image=frame, firstSec=sec, intTime=integrationTime, weighted=True, display=True)['mask']
            plt.show()
...
np.savez('Dec10ATestsdssImageStack6000.npz',stack=cube,jd=times)
utils.makeMovie(showframes,cbar=True,frameTitles=titles,outName='Dec10ATestsdssImageStack6000.gif')
