...
#nFiles = 13 #j0926
#nFiles=25 #crab
nFiles = 9 #try with only 1 file
curves = np.zeros((nFiles,NumFrames),dtype=float)

for k in xrange(nFiles):
    FileName = '/home/srmeeker/scratch/standards/crabNight2_fit_%s.npz'%(k+25)
    print FileName
    t = np.load(FileName)
...
zeros = [759,1461,999,726,487,194] #photons/s/cm^2/Angs
...
plotFileName = "Crab+CorotSpec.pdf"
...
plt.legend(["ARCONS Spectrum of Crab Pulsar","BVRI Fluxes"],numpoints=1)
