...
for k in xrange(nFiles):
    FileName = '/home/srmeeker/scratch/standards/sdssj0926/sdssj0926_fit_%s.npz'%(fileNum)
    print FileName
    t = np.load(FileName)
...
#plt.show()
plotDir = "/home/srmeeker/scratch/standards/sdssj0926"
plotFileName = "sdssj0926_spec_%s.pdf"%(fileNum)
...
plt.plot(rebinned[:,0],rebinned[:,1],color="red")
