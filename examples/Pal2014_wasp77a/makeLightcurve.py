...
scratchDir = '/home/srmeeker/scratch/PAL2014/HAT_P1/'

basePath = '/Scratch/DisplayStack/PAL2014/HAT_P1/'
imageStackPath = os.path.join(basePath, 'ImageStacks/')

targetCentroidPath = os.path.join(basePath, 'CentroidLists/target')
referenceCentroidPath = os.path.join(basePath, 'CentroidLists/ref0')
targetAperturePath = os.path.join(basePath, 'ApertureStacks/target')
referenceAperturePath = os.path.join(basePath, 'ApertureStacks/ref0')

targetApertureRadius = 10
refApertureRadius = 10
annulusInner = 12
annulusOuter = 20
...
targetCentroidFiles = sorted(glob.glob(os.path.join(targetCentroidPath, "Centroid_1.h5")))
...
refCentroidFiles = sorted(glob.glob(os.path.join(referenceCentroidPath, "Centroid_1.h5")))
...
imageFiles = sorted(glob.glob(os.path.join(imageStackPath, "ImageStack_1.h5"))) #change to *_hp.npz to get hot pixel masked versions
