...
outFname = "AllImageStack_20121208_30s_3000-6000_hp.npz"
...
#utils.makeMovie(frames,frameTitles=jds,cbar=True,outName=directory+'AllImageStack_20121208_30s_3000-6000_hp.gif', normMin=200, normMax=5000)
