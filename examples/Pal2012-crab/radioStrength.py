...
from spuriousRadioProb import probsOfGRP
...
dataFilePath = path+'indPulseProfiles_{}sigma_P2_weak.h5'.format(nSigmaRadioCutoff)
...
nPoints = 1000
filledStrengthBins = np.linspace(.13,upperFuncLimit,nPoints)
