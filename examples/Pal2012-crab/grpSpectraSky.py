...
ax.plot(wvlBinEdges,np.append(skySubAvgPeakSpectrum,skySubAvgPeakSpectrum[-1]),'r',drawstyle='steps-post',label='surrounding non-GRP-coincident',linewidth=1.5)
ax.errorbar(wvlBinCenters,skySubPeakSpectrum0,yerr=stdSpectrum,color='k',linestyle='',linewidth=1.5)
ax.plot(wvlBinEdges,np.append(skySubPeakSpectrum0,skySubPeakSpectrum0[-1]),'k',drawstyle='steps-post',label='GRP-coincident',linewidth=1.5)
